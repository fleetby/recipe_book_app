...
<div>
    ...
    <img width=256 src=".readme-assets/dark/search.png">
    <img width=256 src=".readme-assets/dark/recipe.png">
    <img width=256 src=".readme-assets/dark/recipe_directions.png">
    <img width=256 src=".readme-assets/dark/recipe_bottom.png">
    <img width=256 src=".readme-assets/dark/comments.png">
    <img width=256 src=".readme-assets/dark/userprofile.png">
    <img width=256 src=".readme-assets/dark/search_query.png">
    <img width=256 src=".readme-assets/dark/account.png">
    <img width=256 src=".readme-assets/dark/edit_recipe.png">
    <img width=256 src=".readme-assets/dark/edit_recipe_directions.png">
    <img width=256 src=".readme-assets/dark/settings.png">
    <img width=256 src=".readme-assets/dark/settings_language.png">
</div>

### Light Theme
<div>
    <img width=256 src=".readme-assets/light/home.png">
    <img width=256 src=".readme-assets/light/search.png">
    <img width=256 src=".readme-assets/light/recipe.png">
    <img width=256 src=".readme-assets/light/recipe_directions.png">
    <img width=256 src=".readme-assets/light/recipe_bottom.png">
    <img width=256 src=".readme-assets/light/comments.png">
    <img width=256 src=".readme-assets/light/userprofile.png">
    <img width=256 src=".readme-assets/light/search_query.png">
    <img width=256 src=".readme-assets/light/account.png">
    <img width=256 src=".readme-assets/light/edit_recipe.png">
